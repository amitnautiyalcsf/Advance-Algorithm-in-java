package MazeSolverApplicationDFS;
import java.io.File;
...
private int startPositionCol; // Start index of 2 "start point" col index 
private int startPositionRow; // Start index of 2 "start point" row index
